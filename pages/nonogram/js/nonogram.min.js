...
a+",0)",flag:0});f(d,{x:a+gapWidth,y:b+tileSize/2+gapWidth,transform:"rotate("+c+","+a+",0)"});"0"==e.getAttribute("x")?d.textContent=g(s(e)):d.textContent=g(r(e))}function h(){for(var a=document.querySelectorAll("svg>rect"),b=0;b<a.length;b++)currGrid[b]=a[b].getAttribute("curr");if(currGrid.toString()==solGrid.toString())document.getElementsByClassName("svgBanner")[0].style.visibility="visible"}function p(){var a=event.target;1==a.getAttribute("curr")?f(a,{curr:0,flag:1}):1==a.getAttribute("flag")?a.setAttribute("flag",0):a.setAttribute("flag",1);h()}function q(){var a=
event.target;1==a.getAttribute("curr")?f(a,{curr:0,flag:0}):a.setAttribute("curr",1);h()}function t(){0===event.button?q():2===event.button&&p()}function u(){!0===mouseState&&0===event.button?q():!0===mouseState&&2===event.button&&p()}svg=document.getElementById("svgElement");mouseState=!1;gapWidth=5;tileSize=35;gridStart=2*tileSize;gridSize=10;bias=.75;solGrid=[];currGrid=[];(function(){document.onmousedown=function(){mouseState=!0};document.onmouseup=function(){mouseState=!1};svg.parentElement.oncontextmenu=
